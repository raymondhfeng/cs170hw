...
\textbf{Proof of Correctness} \\
The reason that the halving of the two arrays is valid is because at any iteration, we know that the median cannot be in the lower half of the smallest median array, and the upper half of the largest median array. This is because if the lower half of the smallest median array contained the median of the union, then there would be a contradiction, as there are more than $n/2$ elements larger than the median. Symmetrically, the median of the union cannot be within the upper half of the largest median array. This is because if that were the case then there would be a contradiction, as there are more than $n/2$ elements less than the median. Thus, removing the two halves is a valid move. 
}
